import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-282c0a38.js";const i={},l=e(`<h1 id="自动化部署git项目" tabindex="-1"><a class="header-anchor" href="#自动化部署git项目" aria-hidden="true">#</a> 自动化部署git项目</h1><h2 id="创建部署脚本" tabindex="-1"><a class="header-anchor" href="#创建部署脚本" aria-hidden="true">#</a> 创建部署脚本</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/usr/bin/env sh</span>
